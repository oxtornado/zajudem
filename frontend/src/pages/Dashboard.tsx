...
const Dashboard = () => {
  ...
  const filteredItems = filterStatus === 'Todos' 
    ? inventoryItems 
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex space-x-4">
        ...
        <select 
          className="block w-48 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:blue-blue-500 sm:text-sm rounded-md"
          value={filterStatus}
                    ...
                    <tr key={item.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                          ...
                          item.status === 'En uso' ? 'bg-blue-100 text-green-800' :
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button className="text-green-900 hover:text-green-700 mr-4"> 
