  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex space-x-4">
        ...
        <select className="block w-48 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:blue-blue-500 sm:text-sm rounded-md">
          <option>Todos</option>
